            ...
            <div class="row ">
             <div class="col-sm-6 col-sm-push-6 nopad relative">
                  ...
                  <div class="img_tienda" style="background: url(<?php bloginfo('template_url'); ?>/<?php echo $imagen; ?>);" >
                    <div class="marco"></div>       
                                <!-- RECUADRO PARA QUE MUESTRE EL DESCUENTO SOBRE LA IMAGEN DE TIENDA -->
                                  ...
                                  -->
                                                             ...
                                                             <p>Joyas de plata y Oro 18K. Excepto en relojería y Joyas con 
                                                             igual o menor valor a $ 15.000.</p>
                                                           </div>
