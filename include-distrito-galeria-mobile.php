  ...
  <div class="row">
       <div class="col-sm-6">
			...
			<div class="box_more_info">
			  <a href="javascript:void(0);" data-toggle="collapse" data-target="#gal4_xs">Inuguración tienda Tiffany</a>
			</div>
	   </div>
          ...
          <div id="gal4_xsancla" class="anclita_xs5"></div>
            ...
            <!-- content gal   -->
             ...
             <div class="box_more_info">
               <a href="javascript:void(0);" data-toggle="collapse" data-target="#gal76_xs">Otoño de lujo</a>
             </div>
            </div>
                 ...
                 <div id="gal76_xsancla" class="anclita_xs5"></div>
                       <div class="container">
                         ...
                         <div class="row">
                            ...
                            <p>Revive la experiencia de Otoño de Lujo que se vivió en Parque Arauco, de esta formas le dimos 
                            la mejor bienvenida a la temporada.</p>
       ...
       <div class="col-sm-6">
			...
			<div class="box_more_info">
			  <a href="javascript:void(0);" data-toggle="collapse" data-target="#gal1_xs">10 años Tous</a>
			</div>
	   </div>
          ...
          <div id="gal1_xsancla" class="anclita_xs5"></div>                 
           <h4 class="divider">10 años Tous</h4>
            ...
            <div class="col-sm-6">
                ...
                <div class="box_more_info">
                  <a href="javascript:void(0);" data-toggle="collapse" data-target="#gal3_xs">Louis Vuitton</a>
                </div>
            </div>
            ...
            <div class="col-sm-6 hide">
                ...
                <div class="box_more_info">
                  <a href="javascript:void(0);" data-toggle="collapse" data-target="#gal2_xs">Primavera de Lujo</a>
                </div>
            </div>

                  <div id="gal2_xs" class="content_servicio collapse hide">
                        <div class="container">
				 ...
				 <!--<div class="col-sm-6">
					  ...
					  <div class="box_more_info">
						<a href="javascript:void(0);" data-toggle="collapse" data-target="#gal4_xs">Exhibición de autos de lujo</a>
					  </div>
				  </div>-->

                <!--<div id="gal4_xs" class="content_servicio collapse">
                      <div class="container">
                        <h4 class="divider">Exhibición de autos de lujo</h4>
                        <div class="close_servicio"> </div>
                        <div class="row">
                            <div class="col-md-6">
                                  <div class="slider_entrentencion owl-carousel owl-theme">
                            ...
                            <div class="col-md-6  ">
                                 <div class="desc_servicio desc_galeria">
                                   ...
                                   <h4>Exhibición de autos de lujo</h4>
                               		<p>En el marco del Día del Padre, Parque Arauco junto a la Asociación de Marcas de Lujo realizó una exhibición de los autos más destacados y exclusivos del mundo automovilístico. Donde además se dieron a conocer las últimas tendencias que ofrecen las grandes marcas como Ferrari, Maserati, Mercedes-Benz, BMW e Infiniti. Esta muestra tuvo como escenario a Distrito de Lujo hasta el 20 de junio, abierta a todo público. Al evento de inauguración asistieron invitados de todos los ámbitos quienes tuvieron la posibilidad de inscribirse para realizar un test drive. Te invitamos a revisar lo que fue esta extraordinaria exposición de autos de lujo en Parque Arauco.</p>
                               		<div class="btn-mas"><a href="exhibicion_autos_lujo.php">Ver más</a></div>
                                 </div>
                            </div>
                          </div>
                      </div> 
