          ...
          <div class="row">
                        ...
                        <div class="box_slider owl-carousel owl-theme ">
                              <div class="item">
                                  <a href="boulevard.php">
                                       ...
                                       <div class="box_slide" style="background: url(assets/img/portada_zona.png);"> </div>                             
                                  </a>
                               </div> <!-- item -->
                      ...
                      <div class="box_slider owl-carousel owl-theme ">
                           <div class="item">
                               ...
                               <a href="piso-diseno.php">
                                    <div class="logo_seccion logo_piso_diseno" style="background: url(assets/img/logo_piso_diseno.svg);"> </div> 
                                    <div class="box_slide" style="background: url(assets/img/portada_piso_diseno.png);"> </div>                 
                               </a>
                            </div> <!-- item -->
                       ...
                       <div class="box_slider owl-carousel owl-theme">
                         <div class="item">
                            <div class="image_dynamic">
                                 <div class="img_lg" style="background: url(assets/img/emporio_paula_lanas.png);"> </div>
                                 <!--<div class="caption">
                                           <h3>novedades</h3>
            ...
            <div class="row">
              <div class="col-sm-6 col-md-6">
                  <div class="box">
                        ...
                        <a href="arauco-tag.php" class="box_enlace">
                          <div class="box_img" style="background: url(assets/img/bg_arauco_tag.png);"> </div>
                          <div class="caption">
                              <h3>Inscríbete</h3>
                     ...
                     <div class="box_slider owl-carousel owl-theme">
                           <div class="item">
                             <a href="novedades-galeria.php#galerias">
                               ...
                               <div class="box_slide" style="background: url(assets/img/portada_galeria.jpg);"> </div>
                             </a>
                           </div>
                      <!--      <div class="item">
              ...
              <div class="col-sm-6 col-md-6">
                <div class="image_dynamic">
                    <div class="lente"></div>
                    <div class="image_dynamic_portada" style="background: url(assets/img/revista_detalle.jpg);"> </div>
